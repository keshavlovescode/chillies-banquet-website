...
const BanquetHall = () => {
  return (
    <section className="py-20 bg-gradient-to-b from-white to-indiancream" id="banquet-hall">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-4">
            <Building2 className="h-8 w-8 text-indiangold mr-2" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white p-6 rounded-lg shadow-lg border-l-4 border-indiangold">
              ...
              <ul className="space-y-6">
                {features.map((feature, index) => (
                  <li key={index} className="flex">
                    ...
                    <div>
                      <h4 className="text-lg font-semibold text-indianbrown mb-1">{feature.title}</h4>
            ...
            <div className="bg-indiancharcoal text-white p-6 rounded-lg shadow-lg">
              <h3 className="text-xl font-semibold mb-4 text-indiangold">Capacity & Amenities</h3>
